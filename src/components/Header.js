...
import { Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Modal, ModalBody, ModalHeader, FormGroup, Input, Label, Form, Button } from 'reactstrap';
...
class Header extends Component {
    ...
    handleLogin(event) {
        this.toggleModal();
        alert("Username: " + this.username.value + " Password: " + this.password.value + " Remember name:" + this.remember.checked);
